...
describe SingaporeCPFCalculator::Year2015::SPR2GG::Age50BelowContributionCalculator do
  ...
  describe "#calculate" do
    ...
    context "when the total wages amounts to 500.00" do
      ...
      it { expect(result).to eq "total" => 45.00, "employee" => 0.00, "employer" => 45.00 }
    end
    ...
    context "when the total wages amounts to 749.99" do
      ...
      it { expect(result).to eq "total" => 180.00, "employee" => 112.00, "employer" => 68.00 }
    end
    ...
    context "when the total wages amounts to 5,000.00" do
      ...
      it { expect(result).to eq "total" => 1_200.00, "employee" => 750.00, "employer" => 450.00 }
    end
