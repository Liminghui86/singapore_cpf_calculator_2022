...
describe SingaporeCPFCalculator::Year2016::SPR2FG::Age55To60ContributionCalculator do
  ...
  describe "#calculate" do
    ...
    context "when the total wages amounts to 749.99" do
      ...
      it { expect(result).to equal_cpf total: 191.00, employee: 93.00, employer: 98.00 }
    end
    ...
    context "when the total wages amounts to 5,000.00" do
      ...
      it { expect(result).to equal_cpf total: 1_275.00, employee: 625.00, employer: 650.00 }
    end

    context "when the total wages amounts to 10,000.00" do
      let(:ordinary_wages) { 10_000.00 }
      it { expect(result).to equal_cpf total: 1_530.00, employee: 750.00, employer: 780.00 }
    end
