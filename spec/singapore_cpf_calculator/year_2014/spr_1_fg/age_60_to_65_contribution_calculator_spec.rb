...
describe SingaporeCPFCalculator::Year2014::SPR1FG::Age60To65ContributionCalculator do
  ...
  describe "#calculate" do
    ...
    context "when the total wages amounts to 749.99" do
      ...
      it { expect(result).to equal_cpf total: 90.00, employee: 37.00, employer: 53.00 }
    end
    ...
    context "when the total wages amounts to 5,000.00" do
      ...
      it { expect(result).to equal_cpf total: 600.00, employee: 250.00, employer: 350.00 }
    end
