...
describe SingaporeCPFCalculator::Year2014::SPR2GG do
  ...
  describe "calculator_for" do
    ...
    context "when the employee's age is 50 or below" do
      context "lower limit" do
        ...
        it {
          expect( calculator ).
            to be SingaporeCPFCalculator::Year2014::SPR2GG::Age50BelowContributionCalculator
        }
      end
    ...
    context "when the employee's age is above 50 to 55" do
      context "lower limit" do
        ...
        it {
          expect( calculator ).
            to be SingaporeCPFCalculator::Year2014::SPR2GG::Age50To55ContributionCalculator
        }
      end
    ...
    context "when the employee's age is above 55 to 60" do
      context "lower limit" do
        ...
        it {
          expect( calculator ).
            to be SingaporeCPFCalculator::Year2014::SPR2GG::Age55To60ContributionCalculator
        }
      end
    ...
    context "when the employee's age is above 60 to 65" do
      context "lower limit" do
        ...
        it {
          expect( calculator ).
            to be SingaporeCPFCalculator::Year2014::SPR2GG::Age60To65ContributionCalculator
        }
      end
    ...
    context "when the employee's age is 65 or above" do
      context "lower limit" do
        ...
        it {
          expect( calculator ).
            to be SingaporeCPFCalculator::Year2014::SPR2GG::Age65UpContributionCalculator
        }
      end
