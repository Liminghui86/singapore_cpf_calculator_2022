...
describe SingaporeCPFCalculator::Year2014::SPR1FG::Age55To60ContributionCalculator do
  ...
  describe "#calculate" do
    ...
    context "when the total wages amounts to 749.99" do
      ...
      it { expect(result).to equal_cpf total: 116.00, employee: 37.00, employer: 79.00 }
    end
    ...
    context "when the total wages amounts to 5,000.00" do
      ...
      it { expect(result).to equal_cpf total: 775.00, employee: 250.00, employer: 525.00 }
    end
